...
public class Commenting {
  ...
  public static void main(String[] args) {
    ...
    */
    ...
    num1 += 20; // num1 = 40
    num1 = num1 / 3 * 2; // num1 = 26
    num1 = (int)(num2 * 3 - (2 + 5) * 8); //num1 = 52
    num2 = ((int)num2) - num1; // num2 = -16.0
    stringNum = num1 + " " + num2; // stringNum = 52 -16.0
    ...
    */
    ...
    num2 /= 2.5; // num2 = -6.4
    num1 /= 2; // num1 = 26
    stringNum = stringNum + "; "; //stringNum = 52 - 16.0
    stringNum = stringNum + num1 + " " + num2; 
    System.out.print(stringNum); 52 - 16.0 - 6.4   -5; 
